    ...
    <div className='add'>
        <div className="container">
          ...
          <div className="sections">
            ...
            <div className="right">
              <label htmlFor="">Short Service Title</label>
              <input type="text" name="shortTitle" placeholder='e.g. Professional logo design' onChange={handleChange} />
              <label htmlFor="" name="shortTitle">Short Description</label>
              <textarea 
                name="shortDesc" 
                onChange={handleChange}
                id="" 
              ...
              <label htmlFor="">Total Revisions</label>
              <input type="number" min={1} name="revisionNumber"onChange={handleChange}/>
              <label htmlFor="">Add Features</label>
              <form action="" className='add' onSubmit={handleFeature}>
                <input type="text" name="" id="" placeholder='e.g. Brand logo design' />
                <button>Add</button>
              </form>
